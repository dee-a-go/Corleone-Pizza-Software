...
Public Class frm_dados_clientes2
    Private Sub frm_dados_clientes2_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
    ...
    Private Sub frm_dados_clientes2_Closing(sender As Object, e As CancelEventArgs) Handles Me.Closing
        Try
            cpf = ""
            Me.Hide()
